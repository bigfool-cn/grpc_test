...
func (x *SimpleReponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SimpleReponse) ProtoMessage() {}

func (x *SimpleReponse) ProtoReflect() protoreflect.Message {
	mi := &file_simple_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SimpleReponse.ProtoReflect.Descriptor instead.
func (*SimpleReponse) Descriptor() ([]byte, []int) {
	return file_simple_proto_rawDescGZIP(), []int{1}
}

func (x *SimpleReponse) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *SimpleReponse) GetValue() string {
	if x != nil {
		return x.Value
	}
	return ""
...
var file_simple_proto_rawDesc = []byte{
	...
	0x65, 0x61, 0x6d, 0x44, 0x61, 0x74, 0x61, 0x22, 0x39, 0x0a, 0x0d, 0x53, 0x69, 0x6d, 0x70, 0x6c,
	0x65, 0x52, 0x65, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x63, 0x6f, 0x64, 0x65,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x12, 0x14, 0x0a, 0x05,
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c,
	0x75, 0x65, 0x32, 0x4b, 0x0a, 0x0c, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x43, 0x6c, 0x69, 0x65,
	0x6e, 0x74, 0x12, 0x3b, 0x0a, 0x09, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x12,
	...
	0x6d, 0x70, 0x6c, 0x65, 0x52, 0x65, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x28, 0x01, 0x42,
...
var file_simple_proto_goTypes = []interface{}{
	...
	(*SimpleReponse)(nil), // 1: proto.SimpleReponse
}
var file_simple_proto_depIdxs = []int32{
	0, // 0: proto.StreamClient.RouteList:input_type -> proto.StreamRequest
	1, // 1: proto.StreamClient.RouteList:output_type -> proto.SimpleReponse
...
type StreamClient_RouteListClient interface {
	...
	CloseAndRecv() (*SimpleReponse, error)
	grpc.ClientStream
}
...
func (x *streamClientRouteListClient) CloseAndRecv() (*SimpleReponse, error) {
...
type StreamClient_RouteListServer interface {
	SendAndClose(*SimpleReponse) error
...
func (x *streamClientRouteListServer) SendAndClose(m *SimpleReponse) error {
